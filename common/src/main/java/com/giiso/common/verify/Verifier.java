package com.giiso.common.verify;
...
public final class Verifier {
    ...
    private static native String native_signStringArray(String values[]);

    // Used to load the 'native-lib' library on call Verifier class.
    static {
